...
const GetInTouch = () => {
  return (
    <section id="contact" className="flex items-center relative z-20 bg-black">
        ...
        <div className="flex flex-col md:grid grid-cols-2 items-start gap-[28px]">
          ...
          <form data-aos="fade-up" className="flex flex-col gap-[12px] w-full">
            <div className="w-full">
              <input
                type="text"
                className="outline-none bg-transparent desc rounded-[6px] md:rounded-sm border border-white/40 p-[12px] w-full"
                placeholder="Name"
              />
            </div>
            <div className="w-full">
            ...
            <button className="bg-white text-black hover:bg-black hover:text-white border border-black hover:shadow-white/50 cursor-pointer tracking-wide hover:-translate-y-1 shadow-2xl shadow-transparent rounded-full px-[16px] lg:px-4 py-[12px] lg:py-3 w-full hover:border-white flex justify-center text-center transition-all duration-300 font-light text-[14px] lg:text-sm">
              Submit
            </button>
          </form>
        </div>
