...
const GetInTouch = () => {
  return (
    ...
    >
      <div className="wrapper z-0 min-h-[70vh] bg-black text-white py-[60px] md:py-[5rem] relative h-full w-full">
        <div className="flex flex-col md:grid grid-cols-2 items-start gap-[28px]">
          ...
          <form data-aos="fade-up" className="flex flex-col gap-[12px] w-full">
            ...
            <button className="bg-gradient-to-tr from-[#7338AC_30%] via-[#239CE4] to-[#87F3FF] p-[2px] tracking-wide hover:-translate-y-1 shadow-2xl shadow-transparent rounded-full hover:border-white flex justify-center text-center transition-all duration-300 font-light text-[14px] lg:text-sm w-[160px] mx-auto group">
              <div className="px-[16px] lg:px-4 py-[12px] lg:py-3 w-[160px] bg-black rounded-full group-hover:bg-transparent transition-all duration-300">
                Submit
              </div>
            </button>
          </form>
